...
@Component({
  selector: 'app-familiar-diario',
  templateUrl: './familiar-diario.component.html',
  styleUrls: ['./familiar-diario.component.scss']
})
export class FamiliarDiarioComponent extends MatPaginatorIntl {
  ...
  public loadDiario() {
    this.diarioService.getDiarioUser(this.tokenService.getIdUsuario()).subscribe(
      paginas => {
